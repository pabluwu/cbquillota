...
const SolicitudDetalle = () => {
    ...
    return (
        <>
            ...
            {solicitud &&
                <div className="container border mt-5 rounded px-4 py-3">
                            ...
                            <div className="row">
                                ...
                                <div className="mt-3 row g-3">
                                    <div className="col-xl-1 col-lg-2 col-sm-12">
                                        <input className="btn btn-success w-100" type="submit" value="Aprobar"></input>
                                    </div>
                                    <div className="col-xl-1 col-lg-2 col-sm-12">
                                        <input className="btn btn-danger w-100" type="submit" value="Rechazar"></input>
                                    </div>
                                </div>
                            </div>
                        </div>
